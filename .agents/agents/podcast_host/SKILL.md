...
description: Implements the Pipecat-based host interviewer — question generation, interview flow control, and GitHub README context fetching.
---
...
- Save question to DB, wait for agent to poll via `GET /v1/interview/next`
...
## Key Files
- `pipecat_host/workflow.py` — main interview loop
