---
name: GuestAgent
description: External participant agent handling the public SDK integration, polling setup, and end-to-end answer submission. Invoke when implementing or debugging agent SDK connections.
---
...
2. Run `auth_key_verification` skill if seeing 401s
